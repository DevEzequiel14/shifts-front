...
export class ButtonComponent implements OnInit {
  ...
  impactClasses: Record<ButtonProps['tone'], Record<ButtonProps['impact'], string>> = {
    primary: {
      bold: 'bg-primary text-primary-foreground hover:bg-primary-hover focus-visible:ring-primary',
    ...
    danger: {
      bold: 'bg-destructive text-white hover:bg-destructive-hover focus-visible:ring-destructive',
    ...
    light: {
      bold: 'bg-muted text-muted-foreground hover:bg-muted-hover focus-visible:ring-muted',
